...
final class LocalConsultService_Tests: XCTestCase {
    ...
    private func makeSUT(coreDataManager: CoreDataManaging = CoreDataTestManager()) -> ConsultService {
        ConsultService(coreDataManager: coreDataManager)
    }
